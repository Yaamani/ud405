...
public class OrthographicCameraExercise extends ApplicationAdapter {
    ...
    public void resize(int width, int height) {
        ...
        camera.viewportHeight = 2 * (BALL_RADIUS + Y_AMPLITUDE);
        ...
        */
        ...
        camera.viewportWidth = 2 * (BALL_RADIUS + X_AMPLITUDE);
        camera.viewportHeight = aspectRatio * camera.viewportWidth;
    ...
    public void render() {
        ...
        renderer.circle(x, y, BALL_RADIUS, 40);
        renderer.end();
    }
}
